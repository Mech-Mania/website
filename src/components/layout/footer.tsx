        ...
        <div className="my-20 flex flex-col gap-8 justify-items-center items-center flex-wrap">
            ...
            <div className={`flex ${(window.innerWidth > 1024) ? "flex-row gap-32" : "flex-col gap-16"} justify-center items-center`}>
                ...
                <div className="flex flex-col gap-1">
                    ...
                    {/* insta */}
                    <a href={insta_link} target="_blank" className="flex flex-row gap-2 align-middle ease-out hover:brightness-[25%] duration-200 cursor-pointer group">
                        <img src="/icons/instagramLogo.svg" className="w-6 h-6 group-hover:scale-110 ease-out duration-200"/>
                        <p>mechmaniakw</p>
                    </a>

                    {/* github */}
                    <a href={github_link} target="_blank" className="flex flex-row gap-2 align-middle ease-out hover:brightness-[25%] duration-200 cursor-pointer group">
                        <img src="/icons/githubLogo.svg" className="w-6 h-6 group-hover:scale-110 ease-out duration-200"/>
                        <p>mech-mania</p>
                    </a>

                    {/* youtube */}
                    <a href={youtube_link} target="_blank" className="flex flex-row gap-2 align-middle ease-out hover:brightness-[25%] duration-200 cursor-pointer group">
                        <img src="/icons/youtubeLogo.svg" className="w-6 h-6 group-hover:scale-110 ease-out duration-200"/>
                        <p>mechmania-kw</p> 
                    </a>
                    
                    {/* discord */}
                    <a href={discord_link} target="_blank" className="flex flex-row gap-2 align-middle ease-out hover:brightness-[25%] duration-200 cursor-pointer group">
