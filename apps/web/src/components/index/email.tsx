    ...
    return (
        <div className="cont">
            ...
            <div className="mt-2 flex flex-col lg:flex-row gap-2 rounded-full p-2 overflow-hidden bg-m-gray-4">
                <input onKeyDown = {(e)=>{handleKeyPress(e)}} value={email} onChange = {(e)=>{setEmail(e.target.value)}} placeholder="Enter your email to register!" className="text-left outline-none focus:ring bg-m-gray-1 focus:ring-m-black text-m-black p-4 rounded-t-full lg:rounded-l-full lg:rounded-r-none grow"></input>
            ...
            <br/>
            <p>Interested in <a  className="text-m-accent underline cursor-pointer" onClick={()=>{navigate('./sponsor')}}>sponsoring</a> us?</p>
            <br/>
            <hr/>
            <br/>
        </div>
